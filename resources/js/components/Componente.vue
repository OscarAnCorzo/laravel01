<template>
<modal name="demo-login" class="ventana-modal" transition="pop-out" :width="modalWidth" :height="400">
  <div class="box">
    <div class="box-part" id="bp-left">
      <div class="partition" id="partition-register">
        ...
        <button class="large-btn" @click="quitar()"><span>cerrar</span></button>
...
.box {
  ...
  .box-part {
    ...
    width: 50%;
    &#bp-right {
      background: url("/images/hombre.jpg") no-repeat top left;
      box-sizing: cover;
